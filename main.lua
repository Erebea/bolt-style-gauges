...
bolt.onswapbuffers (function (event)
  ...
  if (elements.bank.active and not elements.loot.active) or (elements.central.active) or (elements.lobby.active) then
    ...
    if buffs.livingdeath.active or buffs.sanctity.active or buffs.sorrow.active or buffs.ruination.active or buffs.skeletonwarrior.active then
      cbstyle = "necromancy"
    elseif buffs.sunshine.active or buffs.gsunshine.active or buffs.torment.active or buffs.affliction.active or buffs.metamorphosis.active then
      cbstyle = "magic"
    elseif buffs.deathsswiftness.active or buffs.gdeathsswiftness.active or buffs.anguish.active or buffs.desolation.active then
      cbstyle = "ranged"
    elseif buffs.berserk.active or buffs.turmoil.active or buffs.malevolence.active then
      cbstyle = "melee"
    end
